...
const About = () => {
  return (
    <>
      <div className="bg-primary/20 py-2 px-4 sm:px-[10%]">
        {/* Header */}
        <motion.div
        ...
        >
          <p
          onClick={() => navigate("/")}
          className="text-md md:text-lg w-1/2 md:w-1/3 mx-auto my-2 text-center cursor-pointer bg-secondary text-white font-space font-bold border-2 border-white py-1 px-2 rounded-full whitespace-nowrap"
        >
          FurniGuard &reg;
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-10">
          {expertise.map((item, idx) => (
            <motion.div
              ...
              className="p-6 bg-primary/10 shadow-md rounded-2xl text-center"
            >
        ...
        >
          ...
          <p className="mt-2 text-sm text-primary">— Team FurniGuard</p>
        </motion.div>
      </div>
