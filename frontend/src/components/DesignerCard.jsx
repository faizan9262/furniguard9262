...
const DesignerCard = ({
  ...
  return (
    <Card
      onClick={onClick}
      className="group relative w-full h-[90%] rounded-3xl mt-6 overflow-visible shadow-lg bg-gradient-to-br from-[#f5efe7] via-[#f9f5f0] to-[#f3ebe1] pt-16 pb-6 px-6 cursor-pointer hover:shadow-2xl transition duration-300"
    >
      {/* Floating Profile Image */}
      <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 w-20 h-20 rounded-full border-4 border-primary shadow-md overflow-hidden z-10 bg-primary">
        <img
          src={profile_img}
          alt={name}
