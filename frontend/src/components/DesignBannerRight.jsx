...
const DesignBannerRight = ({ img_src, title, description, onClick }) => {
  ...
  return (
    ...
    >
      <div onClick={onClick} className="flex flex-col cursor-pointer lg:flex-row-reverse items-center gap-0 lg:gap-8">
