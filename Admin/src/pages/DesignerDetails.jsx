...
import { getDesignerRating } from "../helper/apis";
import {
  Avatar,
  AvatarFallback,
  AvatarImage,
  ...
  return (
    <div className="min-h-screen px-4 sm:px-20 py-10 space-y-10">
      ...
      >
        <div className="w-40 h-40 sm:w-52 sm:h-52">
          <img
            ...
            className="w-full h-full object-cover rounded-full shadow-xl border-4 border-[#2d9b67]"
          />
        </div>
        <div className="space-y-4 text-center sm:text-left">
          ...
          <div className="flex items-center justify-center sm:justify-start gap-1 mt-1">
            ...
            <span className="text-xs text-muted-foreground text-primary ml-2">
          ...
          <p className="text-xl font-medium bg-primary/20 text-primary px-4 py-1 rounded-full inline-block border border-secondary capitalize">
      ...
      <section className="space-y-4">
        <h2 className="text-3xl font-semibold text-primary">Service Areas</h2>
